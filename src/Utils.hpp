...
bool ImportMesh(PolyhedraMesh& mesh, string Poliedro);
...
bool ImportCell0Ds(PolyhedraMesh& mesh, string Poliedro);
...
bool ImportCell1Ds(PolyhedraMesh& mesh, string Poliedro);
...
bool ImportCell3Ds(PolyhedraMesh& mesh, string Poliedro);
